...
describe UsersController do
  ...
  describe "POST create" do
    context "With valid inputs" do
      ...
      it "makes the user follow the inviter" do
        ...
        invitation = Fabricate(:invitation, recipient_name: 'helio gracie', message: 'stupid', inviter: alice, recipient_email: 'joe@example.com')
  ...
  describe "GET new_with_invitation_token" do
    it "renders the :new view template" do
      invitation = Fabricate(:invitation, recipient_name: "joe bob", recipient_email: "joebob@joe.com", message: "Join this thing")
